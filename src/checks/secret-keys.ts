...
const ALLOWED_EXTENSIONS = [
    ".py", ".js", ".html", ".css", ".json", ".md", ".txt", ".csv", ".xml",
    ".yaml", ".yml", ".ini", ".conf", ".config", ".log", ".sql", ".sh",
    ".bat", ".dll", ".so", ".dylib", ".jar", ".war", ".php", ".rb", ".go",
    ".rs", ".ts", ".jsx", ".vue", ".cpp", ".c", ".h", ".cs", ".fs", ".vb",
    ".doc", ".docx", ".xls", ".xlsx", ".ppt", ".pptx", ".pdf", ".jpg",
    ".jpeg", ".png"
];
 ...
 */
function isSecretCandidate(s: string, cfg: typeof CONFIGS[keyof typeof CONFIGS], customRegex?: string[]): boolean {
 ...
 */
function detectSecretKeys(text: string, cfg: typeof CONFIGS[keyof typeof CONFIGS], customRegex?: string[]): GuardrailResult {
    ...
    for (const secret of secrets) {
        checkedText = checkedText.replace(new RegExp(secret.replace(/[.*+?^${}()|[\]\\]/g, '\\$&'), 'g'), '<SECRET>');
    }
